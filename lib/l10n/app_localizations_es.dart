...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get readyInitializingBackground =>
      '¡Listo! Inicializando en segundo plano...';

  @override
  String get interfaceReadyDegraded => 'Interfaz lista (modo limitado)';

  @override
  String get ricIsListening =>
      'Ric está escuchando desde el universo espacial...';

  @override
  String get spatialProcessing => 'Procesando en el universo espacial...';

  @override
  String get spatialReady => '¡Listo! Diga \'Hey Ric\' en el universo espacial';
  ...
  String get ricConnectedSpatial =>
      'Ric está conectado en el universo espacial';
